...
//for ZDO_MGMT_NWK_DISC_RSP
#define ZDO_MGMT_NWK_DISC_RSP__SRC_ADDRESS_LSB          (SRSP_PAYLOAD_START+0)
#define ZDO_MGMT_NWK_DISC_RSP__SRC_ADDRESS_MSB          (SRSP_PAYLOAD_START+1)
...
#define ZDO_MGMT_LEAVE_RSP_SRC_ADDRESS_LSB          	(SRSP_PAYLOAD_START+0)
#define ZDO_MGMT_LEAVE_RSP_SRC_ADDRESS_MSB          	(SRSP_PAYLOAD_START+1)
#define ZDO_MGMT_LEAVE_RSP_STATUS_FIELD                 (SRSP_PAYLOAD_START + 2)
#define GET_ZDO_MGMT_LEAVE_RSP_SRC_ADDRESS()      		(CONVERT_TO_INT(zmBuf[ZDO_MGMT_LEAVE_RSP_SRC_ADDRESS_LSB], zmBuf[ZDO_MGMT_LEAVE_RSP_SRC_ADDRESS_MSB]))

#define ZDO_JOIN_CNF_STATUS_FIELD						(SRSP_PAYLOAD_START+0)
#define ZDO_JOIN_CNF_SRC_ADDRESS_LSB          			(SRSP_PAYLOAD_START+1)
#define ZDO_JOIN_CNF_SRC_ADDRESS_MSB          			(SRSP_PAYLOAD_START+2)
#define ZDO_JOIN_CNF_PARENT_ADDRESS_LSB          		(SRSP_PAYLOAD_START+3)
#define ZDO_JOIN_CNF_PARENT_ADDRESS_MSB          		(SRSP_PAYLOAD_START+4)
#define GET_ZDO_JOIN_CNF_SRC_ADDRESS()      			(CONVERT_TO_INT(zmBuf[ZDO_JOIN_CNF_SRC_ADDRESS_LSB], zmBuf[ZDO_JOIN_CNF_SRC_ADDRESS_MSB]))
#define GET_ZDO_JOIN_CNF_PARENT_ADDRESS()      			(CONVERT_TO_INT(zmBuf[ZDO_JOIN_CNF_PARENT_ADDRESS_LSB], zmBuf[ZDO_JOIN_CNF_PARENT_ADDRESS_MSB]))

// For ZDO_STATE_CHANGE_IND
#define ZDO_STATE_CHANGE_IND_STATE						(SRSP_PAYLOAD_START+0)
